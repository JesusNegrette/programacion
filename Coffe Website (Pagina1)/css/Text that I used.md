...
<section class="section review" id="review">
    <div class="review-container container">
        <div class="review-text">
            ...
            <p class="section-description">Some reviews that customer said about coffee services and busine</p>
        </div>
    ...
    `<div class="testimonial swiper mySwiper">`
            `<div class="swiper-wrapper">`
                `<div class="testi-content swiper-slide flex">`
                    ...
                    `<p class="review-quote">`Your coffee hits the spot every time. Thank you for the`</p>`
                    `<i class='bx bxs-quote-alt-left quote-icon'></i>`

    `<div class="testi-personDetails">`
                        `<span class="name">`Marnie Rotter
                        `<span class="job">`App Developer
                    `</div>`
                `</div>`
            `</div>`
        `</div>`
